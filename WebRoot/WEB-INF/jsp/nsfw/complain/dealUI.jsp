...
<form id="form" name="form" action="${basePath }nsfw/complain_deal.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td>
            	<s:property value="complain.isNm?'匿名投诉':'非匿名投诉'"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
            	...
            	<s:date name="complain.compTime" format="yyyy-MM-dd HH-mm-ss"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
            <s:property value="#session.dept"/>
            <s:hidden name="compReply.replyDept" value="%{#session.dept}"/>
            </td>
        </tr>
        <tr>
            ...
            <s:hidden name="compReply.replyer" value="%{#session.SYS_USER.name}"/>
            </td>
        </tr>

        <tr>
            <td class="tdBg" width="200px">回复内容：</td>
            <td><s:textarea name="compReply.replyContent" cols="90" rows="8" /></td>
        </tr>
    </table>
